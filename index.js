...
let colleges = ['Harvard','Caltech', 'MIT', 'Stanford', 'UCLA', 'UC Berkeley', 'Johns Hopkins', 'Georgia Tech', 'Rice', 'Carnegie Mellon', 'U Washington', 'Penn State', 'Cornell', 'Princeton', 'Dartmouth', 'UC Irvine', 'UC Davis', 'San Jose State', 'Santa Clara', 'U Michigan', 'U Wisconsin Madison', 'Texas A&M', 'UT Austin', 'UT Dallas', 'Dartmouth', 'Yale', 'Columbia', 'UPenn', 'ASU', 'UC San Diego', 'UC Santa Barbara', 'UC Santa Cruz', 'UC Riverside', 'UC Merced', 'Cal Poly SLO', 'San Diego State', 'Purdue', 'USC', 'Vanderbilt', 'Duke', 'Tufts', 'U Chicago', 'UIUC', 'Case Western Reserve', 'RPI', 'Rutgers', 'Ohio State', 'Colorado School of Mines', 'CU Boulder', 'Northwestern', 'Northeastern', 'Harvey Mudd', 'Claremont McKenna', 'UT Arlington', 'Temple', 'WashU', 'Pitzer', 'Pomona College', 'Boston University', 'Brown', 'Cal Poly Pomona', 'CSU Monterey Bay', 'CSU Sacramento'];
...
client.login("NDU0NDM1ODUxNTQ4NzUzOTMy.WxnIXg.GavC89q6fVsCVqhrDQ8P4NcrJTA");